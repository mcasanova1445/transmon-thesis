...
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (1/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (2/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (3/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (4/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (5/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (6/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (7/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
print('{}/{}/{} - {}:{}:{}\t Aplicando CMUL7(c=0)^8 (8/8)...'.format(time.localtime()[0], time.localtime()[1], time.localtime()[2], time.localtime()[3], time.localtime()[4], time.localtime()[5]))
res = CMUL7(res.states[-1], 0, 4, 5, 6, 7)
